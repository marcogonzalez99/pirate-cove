...
# Score: Everything the player does will add a set amount of points to their score this score
#        at the end of the game will be converted into money.
...
# Sound
# -----------------------------------------------------------------------------------------
# Use background music/noise and triggered sounds
# - Main Menu Music
# - Credits Music
# - Game Over Music
# - Overworld Music
...
# Visual
# -----------------------------------------------------------------------------------------
# At least 3 elements of visual feedback for the user during gameplay
# - Score Tracker
# - Health bar
# - Coins Collected
# - Diamonds Collected
