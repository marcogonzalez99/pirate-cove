...
class Sky:
    def __init__(self, horizon, world, style='level'):
        self.world = world
        # Based on the current world the player is on, the sky will be a different color
        if world == 0:
            self.top = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_1_sky_top.png'))
            self.bottom = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_1_sky_bottom.png'))
            self.middle = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_1_sky_middle.png'))

        if world == 1:
            self.top = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_2_sky_top.png'))
            self.bottom = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_2_sky_bottom.png'))
            self.middle = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_2_sky_middle.png'))
            
        if world == 2:
            self.top = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_3_sky_top.png'))
            self.bottom = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_3_sky_bottom.png'))
            self.middle = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_3_sky_middle.png'))
            
        if world == 3:
            self.top = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_x_sky_top.png'))
            self.bottom = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_x_sky_bottom.png'))
            self.middle = pygame.image.load(ASSET('graphics', 'decoration', 'sky', 'world_x_sky_middle.png'))
        ...
        # Pre-render full sky only for level style (not overworld)
        if style == 'level':
            self.sky_surface = pygame.Surface((screen_width, vertical_tile_number * tile_size)).convert()
            for row in range(vertical_tile_number):
                y = row * tile_size
                if row < self.horizon:
                    self.sky_surface.blit(self.top, (0, y))
                elif row == self.horizon:
                    self.sky_surface.blit(self.middle, (0, y))
                else:
                    self.sky_surface.blit(self.bottom, (0, y))
